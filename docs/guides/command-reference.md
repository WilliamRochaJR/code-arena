...
Este documento organiza comandos reutilizaveis usados durante a construcao e
operacao do Code Arena. O registro cronologico do que foi efetivamente executado
fica no [diario de terminal](terminal-commands.md).

Os exemplos usam placeholders quando os valores variam. Comandos usados apenas
para criar artefatos pessoais fora do repositorio nao fazem parte desta
referencia.
